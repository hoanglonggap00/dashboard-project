<?php 
    ...
    if (!isset($_SESSION['acc']) || (!getPermission($_SESSION['acc_permission'],'addNewsCategory') && !getPermission($_SESSION['acc_permission'],'deleteNewsCategory')  && !getPermission($_SESSION['acc_permission'],'editNewsCategory')  && !getPermission($_SESSION['acc_permission'],'inspectNewsCategory'))) {
...
<html lang="en">
    <head>
        ...
        <title>Manage News Category</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Manage News Category</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Manage News Category</li>
                        </ol>
                        <?php 
                            $insert = getPermission($_SESSION['acc_permission'],'addNewsCategory') ?  
...
$inspectTableHead = getPermission($_SESSION['acc_permission'],'inspectNewsCategory') ?  
                '<th>'
                    ."ID "
                .'</th>'
                .'<th>'
...
$editTableHead = getPermission($_SESSION['acc_permission'],'editNewsCategory') ?  
                '<th>'
                    ."Action Edit"
                .'</th>' : '';

$deleteTableHead = getPermission($_SESSION['acc_permission'],'deleteNewsCategory') ?  
                '<th>'
                    ."Action Delete"
                .'</th>' : '';
...
$inspectTableBody = getPermission($_SESSION['acc_permission'],'inspectNewsCategory') ?  
                '<td>'
                    .$row["$category__id"]
                ."</td>"
                ."<td>"
...
$editTableBody = getPermission($_SESSION['acc_permission'],'editNewsCategory') ?   
                '<td>'
...
$deleteTableBody = getPermission($_SESSION['acc_permission'],'deleteNewsCategory') ?  
                '<td>'
...
?>
        ...
        if (getPermission($_SESSION['acc_permission'],'addNewsCategory')) {
        echo '<!-- Modal Insert -->
            ...
            <div class="modal-dialog" role="document" style="top:50%; transform:translateY(-50%);">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalLabel">Insert news Category</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form method="post" action="../news_category/insertNewsCategory.php">
        ...
        if (getPermission($_SESSION['acc_permission'],'editNewsCategory')) {
        echo '<!-- Modal Modify -->
        <div class="modal fade" id="modalModify" tabindex="-1" role="dialog" aria-labelledby="Modal">
            <div class="modal-dialog" role="document" style="top:50%; transform:translateY(-50%);">
                <div class="modal-content">
                    ...
                    <form action="../news_category/updateNewsCategory.php" method="post">
                        <div class="modal-body">
        ...
        if (getPermission($_SESSION['acc_permission'],'deleteNewsCategory')) {
        echo '<!-- Modal Delete -->
        <div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="Modal">
            <div class="modal-dialog" role="document" style="top:50%; transform:translateY(-50%);">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../news_category/deleteNewsCategory.php" method="post">
